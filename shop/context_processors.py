...
def site_settings(request):
    ...
    return {
        ...
        'store_address': 'Akbari Gate, Near Nakkhas, Victoria Street, Nakkhas-226003, Lucknow, Uttar Pradesh',
        'store_city': 'Lucknow',
        ...
        'business_reviews': '11.6K+',
        'total_products': total_products,
        'free_shipping_threshold': '999',
        'currency_symbol': '₹',
        'new_customer_discount': '10',
        'whatsapp_subscribers': '50 Lakh+',
        'total_customers': '50 Lakh+',
        'products_sold': '2500+',
    }
